...
public class TestMain {
    private static Map<String, String> sMimeTypeMap = new LinkedHashMap<>();
    static{
...
//        for(Map.Entry<String, String> entry : sMimeTypeMap.entrySet()){
//            System.out.println("sMimeTypeMap.put(\""+entry.getValue()+"\", \""+entry.getKey()+"\");");
//        }
        String str = "# This file maps Internet media types to unique file extension(s).\n" +
        ...
        for(String s : strs){
            ...
            for(int i = ss.length - 1; i>=1;i--){
                if(ss[i] == null || ss[i].length() <= 0) continue;
                System.out.println("sMimeTypeMap.put(\""+ss[i]+"\",\t\""+ss[0]+"\");");
            }
        }
    }
}
