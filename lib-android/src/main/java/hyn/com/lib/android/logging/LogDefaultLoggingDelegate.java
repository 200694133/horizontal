...
package hyn.com.lib.android.logging;
 ...
 */
public class LogDefaultLoggingDelegate implements LoggingDelegate {

  public static final LogDefaultLoggingDelegate sInstance = new LogDefaultLoggingDelegate();

  private String mApplicationTag = "unknown";
  private int mMinimumLoggingLevel = Log.WARN;

  public static LogDefaultLoggingDelegate getInstance() {
    return sInstance;
  }

  private LogDefaultLoggingDelegate() {
  }
