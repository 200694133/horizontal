...
class StrictLineReader implements Closeable {
    ...
    public StrictLineReader(InputStream in, int capacity) {
        this(in, capacity, DiskCharset.ASCII_CHARSET);
    }
    /**
    ...
    public StrictLineReader(InputStream in, int capacity, Charset charset) {
        ...
        if (!(charset.equals(DiskCharset.ASCII_CHARSET) || charset.equals(DiskCharset.UTF8_CHARSET) ||
                charset.equals(DiskCharset.ISO_8859_1_CHARSET))) {
